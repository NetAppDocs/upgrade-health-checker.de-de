...
Stellen Sie außerdem sicher, dass die virtuelle Maschine eine Verbindung zum Telemetrie-Endpunkt (https://support.netapp.com/[] und  https://api.activeiq.netapp.com[] über HTTPS herstellen kann, um NetApp AutoSupport Informationen über Ihre Upgrade-Pläne zu erhalten.
